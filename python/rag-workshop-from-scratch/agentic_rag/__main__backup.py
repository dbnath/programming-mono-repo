...
CHUNK_SIZE = 2048
EMBEDDINGS_API_URL = "https://router.huggingface.co/hf-inference/models/BAAI/bge-small-en-v1.5/pipeline/feature-extraction"
...
def get_embedding(payload):
    json_payload = {"inputs": payload, "options": {"wait_for_model": True}}
