...
public class DocumentWorkflowToolConstant {
	...
	public static String WKFL_DTL_DOC_TAG_REL_SQL = "select a.ID_DOC, a.ID_DOC_TYPE, d.NM_DOC_TYPE, a.ID_DOC_TAG, b.TX_DOC_TAG, a.ID_DOC_SUB_TAG, c.TX_DOC_SUB_TAG, a.CREATED_BY, a.CREATION_DT, a.LAST_UPDATED_BY, a.LAST_UPDATE_DT from doc_tag_rel a, doc_tag_info b, doc_sub_tag_info c, doc_type d where aID_DOC = ? and a.ID_DOC_TAG = b.ID_DOC_TAG and a.ID_DOC_SUB_TAG = c.ID_DOC_SUB_TAG and a.ID_DOC_TYPE = d.ID_DOC_TYPE";
